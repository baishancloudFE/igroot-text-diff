(function () {
  ...
  diff_match_patch.prototype.diff_main = function (a, b, c, d) {
    'undefined' == typeof d && (d = 0 >= this.Diff_Timeout
      ? Number.MAX_VALUE
    ...
    return -1 != g
      ...
      : 1 == f.length
        ...
        : (e = this.diff_halfMatch_(a, b))
          ? (f = e[0], a = e[1], g = e[2], b = e[3], e = e[4], f = this.diff_main(f, g, c, d), c = this.diff_main(a, b, c, d), f.concat([
            [0, e]
          ], c))
  ...
  diff_match_patch.prototype.diff_commonPrefix = function (a, b) {
    ...
    for (var c = 0, d = Math.min(a.length, b.length), e = d, f = 0; c < e;) 
      a.substring(f, e) == b.substring(f, e)
        ? f = c = e
        : d = e,
    ...
    for (var b = !1, c = [], d = 0, e = null, f = 0, g = 0, h = 0, j = 0, i = 0; f < a.length;) 
      0 == a[f][0]
        ...
        : (1 == a[f][0]
          ? j += a[f][1].length
          : i += a[f][1].length,
        e && (e.length <= Math.max(g, h) && e.length <= Math.max(j, i)) && (a.splice(c[d - 1], 0, [-1, e]), a[c[d - 1] + 1][0] = 1,
        d--,
        d--,
        f = 0 < d
          ? c[d - 1]
  ...
  diff_match_patch.prototype.diff_cleanupMerge = function (a) {
    ...
    for (var b = 0, c = 0, d = 0, e = '', f = '', g; b < a.length;) 
      ...
      case 0:
        1 < c + d
          ? (0 !== c && 0 !== d && (g = this.diff_commonPrefix(f, e), 0 !== g && (0 < b - c - d && 0 == a[b - c - d - 1][0]
            ? a[b - c - d - 1][1] += f.substring(0, g)
            : (a.splice(0, 0, [
              0, f.substring(0, g)
            ]), b++),
          f = f.substring(g),
          e = e.substring(g)), g = this.diff_commonSuffix(f, e), 0 !== g && (a[b][1] = f.substring(f.length - g) + a[b][1],
          f = f.substring(0, f.length - g),
          e = e.substring(0, e.length - g))), 0 === c
    ...
    for (b = 1; b < a.length - 1;) 
      0 == a[b - 1][0] && 0 == a[b + 1][0] && (a[b][1].substring(a[b][1].length - a[b - 1][1].length) == a[b - 1][1]
        ? (a[b][1] = a[b - 1][1] + a[b][1].substring(0, a[b][1].length - a[b - 1][1].length),
        a[b + 1][1] = a[b - 1][1] + a[b + 1][1],
        a.splice(b - 1, 1),
        c = !0)
        : a[b][1].substring(0, a[b + 1][1].length) == a[b + 1][1] && (a[b - 1][1] += a[b + 1][1],
  ...
  diff_match_patch.prototype.diff_fromDelta = function (a, b) {
    ...
    function d(a, d) {
      var e = a / b.length,
        g = Math.abs(c - d)
        return !f.Match_Distance
        ? g
          ? 1
          : e
        : e + g / f.Match_Distance
    }
    ...
    if (0 != b.length) {
      for (var c = b.substring(a.start2, a.start2 + a.length1), d = 0; b.indexOf(c) != b.lastIndexOf(c) && c.length < this.Match_MaxBits - this.Patch_Margin - this.Patch_Margin;) 
        ...
        d += this.Patch_Margin;
      (c = b.substring(a.start2 - d, a.start2)) && a
        .diffs
        .unshift([0, c]);
      (d = b.substring(a.start2 + a.length1, a.start2 + a.length1 + d)) && a
        .diffs
        .push([0, d])
        a.start1 -= c.length
        a.start2 -= c.length
    ...
    var d
      ...
      case 0:
        k.length <= 2 * this.Patch_Margin && e && b.length != j + 1
          ...
          : k.length >= 2 * this.Patch_Margin && e && (this.patch_addContext_(a, h), c.push(a), a = new diff_match_patch.patch_obj, e = 0, h = d, f = g)
      }
      1 !== i && (f += k.length);
      -1 !== i && (g += k.length)
    }
    ...
    if (0 == a.length) 
      ...
      var g = a[f].start2 + d,
        ...
        else if (e[f] = !0, d = j - g, g = -1 == i
        ? b.substring(j, j + h.length)
        : b.substring(j, i + this.Match_MaxBits), h == g) 
        b = b.substring(0, j) + this.diff_text2(a[f].diffs) + b.substring(j + h.length)
        else if (g = this.diff_main(h, g, !1), h.length > this.Match_MaxBits && this.diff_levenshtein(g) / h.length > this.Patch_DeleteThreshold) 
        e[f] = !1
        else {
        this.diff_cleanupSemanticLossless(g)
          ...
          var q = a[f].diffs[i]
            ...
            : -1 === q[0] && (b = b.substring(0, j + k) + b.substring(j + this.diff_xIndex(g, h + q[1].length)));
          -1 !== q[0] && (h += q[1].length)
        }
      }
    }
    ...
    d = a[a.length - 1]
      ...
      : b > e[e.length - 1][1].length && (f = b - e[e.length - 1][1].length,
      ...
      if (!(a[c].length1 <= b)) {
        var d = a[c]
          ...
          var h = new diff_match_patch.patch_obj,
            ...
            var g = d.diffs[0][0],
              ...
              : -1 === g && 1 == h.diffs.length && 0 == h.diffs[0][0] && i.length > 2 * b
                ? (h.length1 += i.length, e += i.length, j = !1, h.diffs.push([g, i]), d.diffs.shift())
                : (i = i.substring(0, b - h.length1 - this.Patch_Margin), h.length1 += i.length, e += i.length, 0 === g
                  ? (h.length2 += i.length, f += i.length)
                  : j = !1, h.diffs.push([g, i]), i == d.diffs[0][1]
                  ? d.diffs.shift()
          ...
          g = this.diff_text2(h.diffs)
            ...
            "" !== i && (h.length1 += i.length, h.length2 += i.length, 0 !== h.diffs.length && 0 === h.diffs[h.diffs.length - 1][0]
